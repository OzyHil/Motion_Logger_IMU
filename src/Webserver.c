...
static err_t tcp_server_recv(void *arg, struct tcp_pcb *tpcb, struct pbuf *p, err_t err)
{
    ...
    snprintf(html, sizeof(html),
             ...
             ".barra { position: relative; width: 100%%; background: #ccc; border-radius: 12px; overflow: hidden; height: 25px; margin: 10px 0; border: 1px solid #aaa; }\r\n"

             ".linha-limiar { position: absolute; top: 0; bottom: 0; width: 5px; background-color: #f44336; z-index: 10; }\r\n"
             ...
             "<div class=\"barra\"><div id=\"barraNivel\" class=\"preenchimento\"></div>\r\n"
             "<div id=\"linhaMinimo\" class=\"linha-limiar\"></div>\r\n"
             "<div id=\"linhaMaximo\" class=\"linha-limiar\"></div></div>\r\n"
             ...
             "const porcentagemMin = (data.min_config * 100) / %d;\r\n"
             "const porcentagemMax = (data.max_config * 100) / %d;\r\n"
